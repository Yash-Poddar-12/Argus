...
[ ] Local startup verified (`python scripts/dev.py up`, your module's compose file)
[ ] workstream status updated (WP → DONE, log line); catalogs rows updated (status column)
