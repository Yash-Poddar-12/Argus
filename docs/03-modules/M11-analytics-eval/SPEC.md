...
| Type | Research/eval (`analytics/`) + small backend module (+ admin analytics slot) |
...
`analytics/`, `backend/modules/m11_analytics/`, `backend/migrations/m11_analytics/`, `backend/tests/m11_analytics/`, `contracts/openapi/m11-analytics.yaml`; slot `frontend/apps/admin/src/{app,features}/analytics/` if held.
