"""Deterministic machine/site simulator (M01-WP2).
...
from simulator.core.scenario import Scenario

# SITE_A zone centres (lon, lat), matching backend/modules/m00_platform/seed.py
