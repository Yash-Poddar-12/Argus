"""Simulator CLI: ``python -m app.iot.simulator --scenario S1 --seed 42 [--demo-g1] [--speed 1]``
(or ``python scripts/dev.py sim ...``).
...
from app.iot.simulator.sinks import HttpSink, JsonlSink
