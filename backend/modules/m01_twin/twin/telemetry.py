"""Telemetry ingestion (M01-WP3): persist -> fold into machine state -> events -> twin refresh.
...
from backend.modules.m01_twin.models import MachineStateChange, MachineTelemetry
from backend.modules.m01_twin.public import TelemetryPoint
from backend.modules.m01_twin.tasks.service import ensure_session_baseline
