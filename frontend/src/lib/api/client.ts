/** Minimal typed fetch wrapper around the platform API. Types come from ./generated (contracts/openapi/argus-api.yaml). */
...
/** Fired on window whenever the session changes (hooks/useSession subscribes to it). */
export const SESSION_EVENT = "argus:session";
